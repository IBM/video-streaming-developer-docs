            ...
            <ul className={nav}>
              {secondCol &&
                secondCol.map((link, i) => (
                  <li key={i} className={listItem}>
                    <a href={link.href} aria-label={link.linkText} onClick={link.onClick}>
                      {link.linkText}
                    </a>
                  </li>
                ))}
...
const DefaultContent = () => <p>Shadow this content by importing the theme Footer and supplying your own props.</p>;
