...
- [Organization Settings](/organization-api/organization-settings): allows to list Organizations and change the Organization's name
- [SSO Settings](/organization-api/sso-settings): allows to configure the Account's SSO login settings under the Organization. Currently two types of SSO providers are supported: Google Apps and SAML based
- [Administrators](/organization-api/administrators): These calls allow to manage the Administrators and their Permissions
- [Custom Roles](/organization-api/custom-roles): Other than the build in roles like Organization Administrator and Channel Administrator you can create Custom Roles and associate permissions to them
...
| NAME                       | DESCRIPTION                                                                                                                                                                                       |
| -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Organization Administrator | Can manage settings and content of an Organization (SSO Settings, Administrators, Accounts, Channels and Videos). You can thin an Organization Administrator as a "Superuser" in the Organization |
