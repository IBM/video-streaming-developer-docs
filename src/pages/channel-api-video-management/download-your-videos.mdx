...
On success a response with HTTP status "200 OK" is returned with the following key-value pairs under a `downloadable` key.
...
## Request a downloadable version of a video
