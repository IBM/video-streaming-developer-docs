...
In this stage you need to upload the video file in 1MB parts. You can find an example of this in the downloadable PHP sample code: https://developers.video.ibm.com/video-replacement-api-php-sample-code
...
```
GET https://api.video.ibm.com/videos/{video_id}/replacement/cancel.json
```
