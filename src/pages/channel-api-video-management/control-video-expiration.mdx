...
On success a response with HTTP status "200 OK" is returned with the following key-value pairs under an `expiration` key.
...
You can set the video to never expire.
