...
| received | [DataTransferPoint](../ecdn-api-objects/DataTransferPoint) | NO | YES | Received data transfer rate. Nullable in case of errors (coming from an external service). | 
| transmitted | [DataTransferPoint](../ecdn-api-objects/DataTransferPoint) | NO | YES | Transmitted data transfer rate. Nullable in case of errors (coming from an external service). | 
