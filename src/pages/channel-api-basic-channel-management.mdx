...
| `sort`      | string  | OPTIONAL   | Search sorting criteria.  Possible values: `recent` (default), `popular`, `title`, `duration`, `relevance` |
| `direction` | string  | OPTIONAL   | Search sorting order.  Possible values: `desc` (default), `asc` |
