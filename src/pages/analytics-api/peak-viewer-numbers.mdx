...
On success a response with HTTP status “200 OK” is returned with an array under a `data` key. The elements of the array contain every data point wrapped in a `PeakSeries` object
