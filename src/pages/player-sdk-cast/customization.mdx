...
Apply your brand colors, use your logo and your custom typeface to customize the look and feel of your receiver.
Achieve a personalised look by modifying css variables in the `css/receiver.css` file.

</PageDescription>

_The whole list of available variables can be found [here](https://developers.google.com/cast/docs/web_receiver/customize_ui)._
