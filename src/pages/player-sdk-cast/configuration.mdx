...
The downloaded archive is a reference implementation of a Google Cast [Styled Media Receiver], and has the followong content.
...
<CardGroup>
  ...
  <MiniCard
    ...
    href={withPrefix('/player-sdk-android/getting-started')}
  />
</CardGroup>
