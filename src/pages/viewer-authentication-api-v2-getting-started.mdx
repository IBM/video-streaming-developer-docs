...
The JWS is signed with your private key that you set to the content. The JWE is encrypted with Video Streaming's public key that you can get from the API. [See more](/viewer-authentication-api-v2-settings-api#get-ibm-video-streaming-public-key)
