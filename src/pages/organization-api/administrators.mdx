...
- `channel.admin`
- a permission from one of the Organization's [Custom Role](/organization-api/custom-roles)
...
| KEY      | TYPE  | IMPORTANCE | DESCRIPTION                                                                                                                                        |
| -------- | ----- | ---------- | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| `set`    | array | OPTIONAL   | An array of key-value pairs of Channel IDs (`id`) and access levels (`role`). Access level: `channel.admin` or a permission from one of the Organization's [Custom Role](/organization-api/custom-roles) |
