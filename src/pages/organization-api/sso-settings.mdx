...
| `logout_mode`      | string | REQUIRED   | Login mode. Possible values: `local`, `global` |
| `logout_url`       | string | OPTIONAL   | Logout URL. Required if Login mode is global   |
...
entity_id=https%3A%2F%2Fsso.example.info%2Fentity&certificate_data=MIIJnz...&login_url=example.com%2Flogin&logout_mode=global&logout_url=example.com%2Flogout
```
