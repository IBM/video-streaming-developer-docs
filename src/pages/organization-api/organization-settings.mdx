...
This API call allows to get all the Organizations accessible to the user represented by the token.
...
On success, a set of key-value pairs is returned under an `organizations` element with an HTTP Status code of 200.
...
This API call allows to get an Organization.
...
On success, the Organization name is returned with an HTTP Status code of 200.
