...
On success, a set of key-value pairs is returned under a `custom_roles` element with an HTTP Status code of 200.
...
On success, a set of key-value pairs is returned with an HTTP Status code of 201.
